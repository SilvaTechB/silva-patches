...
package app.silva.util

import app.morphe.patcher.extensions.InstructionExtensions.getInstruction
import app.morphe.patcher.extensions.InstructionExtensions.instructions
import app.silva.util.FreeRegisterProvider.Companion.conditionalBranchOpcodes
import app.silva.util.FreeRegisterProvider.Companion.logFreeRegisterSearch
import app.silva.util.FreeRegisterProvider.Companion.returnOpcodes
import app.silva.util.FreeRegisterProvider.Companion.switchOpcodes
import app.silva.util.FreeRegisterProvider.Companion.unconditionalBranchOpcodes
import app.silva.util.FreeRegisterProvider.Companion.writeOpcodes
...
private fun Method.findInstructionIndexByOffset(
    ...
    throw IllegalArgumentException("Could not find exact instruction offset for method: " +
            "$this at offset: $targetOffset. Please file a bug report in the Silva patches repo"
    )
}
