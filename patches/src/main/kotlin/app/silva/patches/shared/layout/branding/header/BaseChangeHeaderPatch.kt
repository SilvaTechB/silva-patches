...
package app.silva.patches.shared.layout.branding.header
...
const val CUSTOM_HEADER_RESOURCE_NAME = "silva_header_custom"
...
internal fun baseChangeHeaderPatch(
    ...
    execute {
        preferenceScreen.addPreferences(
            if (custom == null) {
                ListPreference("silva_header_logo")
            } else {
                ListPreference(
                    key = "silva_header_logo",
                    entriesKey = "silva_header_logo_custom_entries",
                    entryValuesKey = "silva_header_logo_custom_entry_values"
                )
            }
        )
