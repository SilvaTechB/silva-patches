package app.silva.patches.shared.misc.settings.preference

import app.silva.util.resource.ArrayResource
import app.silva.util.resource.BaseResource
...
class ListPreference(
    ...
    layout: String? = null,
    tag: String = "app.silva.extension.shared.settings.preference.CustomDialogListPreference",
