...
package app.silva.patches.shared.misc.gms
...
import app.silva.patches.all.misc.packagename.changePackageNamePatch
import app.silva.patches.all.misc.packagename.setOrGetFallbackPackageName
import app.silva.patches.shared.misc.gms.Constants.ACTIONS
import app.silva.patches.shared.misc.gms.Constants.AUTHORITIES
import app.silva.patches.shared.misc.gms.Constants.PERMISSIONS
...
fun gmsCoreSupportResourcePatch(
    ...
    execute {
        ...
        screen.addPreferences(
            ...
            SwitchPreference("silva_gms_core_battery_optimization_dialog")
        )
