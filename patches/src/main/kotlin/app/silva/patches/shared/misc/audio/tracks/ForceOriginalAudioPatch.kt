package app.silva.patches.shared.misc.audio.tracks
...
import app.silva.util.findMethodFromToString
...
internal fun forceOriginalAudioPatch(
    ...
    execute {
        preferenceScreen.addPreferences(
            SwitchPreference(
                key = "silva_force_original_audio",
                tag = "app.silva.extension.shared.settings.preference.ForceOriginalAudioSwitchPreference"
            )
        )
