package app.silva.patches.youtube.layout.shortsautoplay
...
import app.silva.patches.youtube.misc.playservice.is_20_09_or_greater
import app.silva.patches.youtube.misc.playservice.is_21_10_or_greater
...
private const val EXTENSION_CLASS_DESCRIPTOR = "Lapp/silva/extension/youtube/patches/ShortsAutoplayPatch;"
...
val shortsAutoplayPatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.SHORTS.addPreferences(
            SwitchPreference("silva_shorts_autoplay"),
        )

        if (is_19_34_or_greater) {
            PreferenceScreen.SHORTS.addPreferences(
                SwitchPreference("silva_shorts_autoplay_background"),
            )
        }
