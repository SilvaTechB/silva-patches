...
package app.silva.patches.youtube.layout.hide.general
...
import app.silva.patches.youtube.layout.hide.shelves.hideHorizontalShelvesPatch
import app.silva.patches.youtube.layout.hide.updatescreen.hideUpdateScreenPatch
...
import app.silva.patches.youtube.misc.litho.lazily.hookTreeNodeResult
...
import app.silva.patches.youtube.misc.playservice.is_20_10_or_greater
import app.silva.patches.youtube.misc.playservice.is_20_21_or_greater
import app.silva.patches.youtube.misc.playservice.is_21_11_or_greater
import app.silva.patches.youtube.misc.playservice.versionCheckPatch
import app.silva.patches.youtube.misc.proto.elementProtoParserHookPatch
import app.silva.patches.youtube.misc.proto.hookElement
...
import app.silva.util.injectHideViewCall
...
val hideLayoutComponentsPatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.ADS.addPreferences(
            ...
            SwitchPreference("silva_hide_creator_store_shelf")
        )

        PreferenceScreen.PLAYER.addPreferences(
            PreferenceScreenPreference(
                key = "silva_hide_description_components_screen",
                preferences = setOf(
                    SwitchPreference("silva_hide_ai_generated_video_summary_section"),
                    SwitchPreference("silva_hide_ask_section"),
                    SwitchPreference("silva_hide_attributes_section"),
                    SwitchPreference("silva_hide_chapters_section"),
                    SwitchPreference("silva_hide_course_progress_section"),
                    SwitchPreference("silva_hide_explore_section"),
                    SwitchPreference("silva_hide_explore_course_section"),
                    SwitchPreference("silva_hide_explore_podcast_section"),
                    SwitchPreference("silva_hide_featured_links_section"),
                    SwitchPreference("silva_hide_featured_places_section"),
                    SwitchPreference("silva_hide_featured_videos_section"),
                    SwitchPreference("silva_hide_gaming_section"),
                    SwitchPreference("silva_hide_how_this_was_made_section"),
                    SwitchPreference("silva_hide_hype_points"),
                    SwitchPreference("silva_hide_info_cards_section"),
                    SwitchPreference("silva_hide_key_concepts_section"),
                    SwitchPreference("silva_hide_music_section"),
                    SwitchPreference("silva_hide_subscribe_button"),
                    SwitchPreference("silva_hide_transcript_section"),
                    SwitchPreference("silva_hide_quizzes_section"),
                ),
            ),
            PreferenceScreenPreference(
                "silva_comments_screen",
                preferences = setOf(
                    PreferenceCategory(
                        titleKey = null,
                        ...
                        preferences = setOf(
                            SwitchPreference("silva_hide_comments_carousel"),
                            TextPreference(
                                "silva_hide_comments_carousel_filter_strings",
                                inputType = InputType.TEXT_MULTI_LINE
                            ),
                        )
                    ),
                    SwitchPreference("silva_hide_comments_ai_chat_summary"),
                    SwitchPreference("silva_hide_comments_channel_guidelines"),
                    SwitchPreference("silva_hide_comments_prompts"),
                    SwitchPreference("silva_hide_comments_by_members_header"),
                    SwitchPreference("silva_hide_comments_section"),
                    SwitchPreference("silva_hide_comments_section_in_home_feed"),
                    SwitchPreference("silva_hide_comments_community_guidelines"),
                    SwitchPreference("silva_hide_comments_create_a_short_button"),
                    SwitchPreference("silva_hide_comments_emoji_and_timestamp_buttons"),
                    SwitchPreference("silva_hide_comments_info_button"),
                    SwitchPreference("silva_hide_comments_preview_comment"),
                    SwitchPreference("silva_hide_comments_thanks_button"),
                    SwitchPreference("silva_sanitize_comments_category_bar"),
                ),
                sorting = Sorting.UNSORTED,
            ),
            SwitchPreference("silva_hide_channel_bar"),
            SwitchPreference("silva_hide_channel_watermark"),
            SwitchPreference("silva_hide_crowdfunding_box"),
            SwitchPreference("silva_hide_emergency_box"),
            SwitchPreference("silva_hide_info_panels"),
            SwitchPreference("silva_hide_join_membership_button"),
            SwitchPreference("silva_hide_live_chat_replay_button"),
            SwitchPreference("silva_hide_medical_panels"),
            SwitchPreference("silva_hide_quick_actions"),
            SwitchPreference("silva_hide_quick_actions_related_videos"),
            SwitchPreference("silva_hide_subscribers_community_guidelines"),
            SwitchPreference("silva_hide_timed_reactions"),
            SwitchPreference("silva_hide_video_title"),
        )

        PreferenceScreen.FEED.addPreferences(
            PreferenceScreenPreference(
                key = "silva_hide_keyword_content_screen",
                sorting = Sorting.UNSORTED,
                preferences = setOf(
                    SwitchPreference("silva_hide_keyword_content_home"),
                    SwitchPreference("silva_hide_keyword_content_subscriptions"),
                    SwitchPreference("silva_hide_keyword_content_search"),
                    TextPreference("silva_hide_keyword_content_phrases", inputType = InputType.TEXT_MULTI_LINE),
                    NonInteractivePreference(
                        key = "silva_hide_keyword_content_about",
                        tag = "app.silva.extension.shared.settings.preference.BulletPointPreference"
                    ),
                    NonInteractivePreference(
                        key = "silva_hide_keyword_content_about_whole_words",
                        tag = "app.silva.extension.youtube.settings.preference.HTMLPreference",
                    ),
                ),
            ),
            PreferenceScreenPreference(
                key = "silva_hide_filter_bar_screen",
                preferences = setOf(
                    SwitchPreference("silva_hide_filter_bar_feed_in_feed"),
                    SwitchPreference("silva_hide_filter_bar_feed_in_related_videos"),
                    SwitchPreference("silva_hide_filter_bar_feed_in_search"),
                    SwitchPreference("silva_hide_filter_bar_feed_in_history"),
                ),
            ),
            PreferenceScreenPreference(
                key = "silva_channel_screen",
                preferences = setOf(
                    PreferenceCategory(
                        titleKey = null,
                        sorting = Sorting.UNSORTED,
                        tag = "app.silva.extension.shared.settings.preference.NoTitlePreferenceCategory",
                        preferences = setOf(
                            SwitchPreference("silva_hide_channel_tab"),
                            TextPreference(
                                "silva_hide_channel_tab_filter_strings",
                                inputType = InputType.TEXT_MULTI_LINE
                            ),
                        )
                    ),
                    SwitchPreference("silva_hide_community_button"),
                    SwitchPreference("silva_hide_join_button"),
                    SwitchPreference("silva_hide_links_preview"),
                    SwitchPreference("silva_hide_members_shelf"),
                    SwitchPreference("silva_hide_store_button"),
                    SwitchPreference("silva_hide_subscribe_button_in_channel_page"),
                ),
            ),
            SwitchPreference("silva_hide_album_cards"),
            SwitchPreference("silva_hide_artist_cards"),
            SwitchPreference("silva_hide_chips_shelf"),
            SwitchPreference("silva_hide_community_posts"),
            SwitchPreference("silva_hide_compact_banner"),
            SwitchPreference("silva_hide_expandable_card"),
            PreferenceCategory(
                titleKey = null,
                sorting = Sorting.UNSORTED,
                tag = "app.silva.extension.shared.settings.preference.NoTitlePreferenceCategory",
                preferences = setOf(
                    SwitchPreference("silva_hide_feed_flyout_menu"),
                    TextPreference(
                        "silva_hide_feed_flyout_menu_filter_strings",
                        inputType = InputType.TEXT_MULTI_LINE
                    ),
                )
            ),
            SwitchPreference("silva_hide_floating_microphone_button"),
            SwitchPreference(
                key = "silva_hide_horizontal_shelves",
                tag = "app.silva.extension.shared.settings.preference.BulletPointSwitchPreference"
            ),
            SwitchPreference("silva_hide_image_shelf"),
            SwitchPreference("silva_hide_latest_posts"),
            SwitchPreference("silva_hide_latest_videos_button"),
            SwitchPreference("silva_hide_mix_playlists"),
            SwitchPreference("silva_hide_movies_section"),
            SwitchPreference("silva_hide_notify_me_button"),
            SwitchPreference("silva_hide_playables"),
            SwitchPreference("silva_hide_show_more_button"),
            SwitchPreference("silva_hide_subscribed_channels_bar"),
            SwitchPreference("silva_hide_surveys"),
            SwitchPreference("silva_hide_ticket_shelf"),
            SwitchPreference("silva_hide_upload_time"),
            SwitchPreference("silva_hide_video_recommendation_labels"),
            SwitchPreference("silva_hide_view_count"),
            SwitchPreference("silva_hide_web_search_results"),
            SwitchPreference("silva_hide_doodles"),
        )

        if (is_20_21_or_greater) {
            PreferenceScreen.FEED.addPreferences(
                SwitchPreference("silva_hide_you_may_like_section")
            )
        }

        PreferenceScreen.GENERAL.addPreferences(
            PreferenceScreenPreference(
                key = "silva_custom_filter_screen",
                sorting = Sorting.UNSORTED,
                preferences = setOf(
                    SwitchPreference("silva_custom_filter"),
                    TextPreference("silva_custom_filter_strings", inputType = InputType.TEXT_MULTI_LINE),
                ),
            ),
        )
