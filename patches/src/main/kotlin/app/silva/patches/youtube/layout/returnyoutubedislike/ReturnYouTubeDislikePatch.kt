package app.silva.patches.youtube.layout.returnyoutubedislike
...
import app.silva.patches.youtube.misc.litho.context.EXTENSION_CONTEXT_INTERFACE
import app.silva.patches.youtube.misc.litho.context.conversionContextClassDef
import app.silva.patches.youtube.misc.litho.context.conversionContextPatch
...
import app.silva.patches.youtube.misc.playservice.is_19_33_or_greater
...
import app.silva.patches.youtube.video.videoid.hookPlayerResponseVideoId
import app.silva.patches.youtube.video.videoid.hookVideoId
import app.silva.patches.youtube.video.videoid.videoIdPatch
...
val returnYouTubeDislikePatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.RETURN_YOUTUBE_DISLIKE.addPreferences(
            SwitchPreference("silva_ryd_enabled"),
            SwitchPreference("silva_ryd_shorts"),
            SwitchPreference("silva_ryd_dislike_percentage"),
            SwitchPreference("silva_ryd_compact_layout"),
            SwitchPreference("silva_ryd_estimated_like"),
            SwitchPreference("silva_ryd_toast_on_connection_error"),
            NonInteractivePreference(
                key = "silva_ryd_attribution",
                tag = "app.silva.extension.youtube.returnyoutubedislike.ui.ReturnYouTubeDislikeAboutPreference",
                selectable = true,
            ),
            PreferenceCategory(
                key = "silva_ryd_statistics_category",
                sorting = PreferenceScreenPreference.Sorting.UNSORTED,
                preferences = emptySet(), // Preferences are added by custom class at runtime.
                tag = "app.silva.extension.youtube.returnyoutubedislike.ui.ReturnYouTubeDislikeDebugStatsPreferenceCategory"
            )
        )
