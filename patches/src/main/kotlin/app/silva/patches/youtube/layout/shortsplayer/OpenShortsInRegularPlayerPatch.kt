package app.silva.patches.youtube.layout.shortsplayer
...
import app.silva.patches.youtube.layout.player.fullscreen.openVideosFullscreenHookPatch
...
import app.silva.patches.youtube.misc.playservice.is_21_07_or_greater
...
import app.silva.patches.youtube.video.information.PlaybackStartDescriptorToStringFingerprint
...
import app.silva.util.registersUsed
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/silva/extension/youtube/patches/OpenShortsInRegularPlayerPatch;"
...
val openShortsInRegularPlayerPatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.SHORTS.addPreferences(
            ListPreference("silva_shorts_player_type")
        )
