package app.silva.patches.youtube.layout.buttons.overlay
...
private const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/silva/extension/youtube/patches/HidePlayerOverlayButtonsPatch;"
...
val hidePlayerOverlayButtonsPatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.PLAYER.addPreferences(
            SwitchPreference("silva_hide_autoplay_button"),
            SwitchPreference("silva_hide_captions_button"),
            SwitchPreference("silva_hide_cast_button"),
            SwitchPreference("silva_hide_collapse_button"),
            SwitchPreference("silva_hide_fullscreen_button"),
            SwitchPreference("silva_hide_player_control_buttons_background"),
            SwitchPreference("silva_hide_player_previous_next_buttons"),
        )
