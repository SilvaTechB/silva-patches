...
package app.silva.patches.youtube.video.speed.remember
...
import app.silva.patches.youtube.video.information.setPlaybackSpeedClassFieldReferenceRef
import app.silva.patches.youtube.video.information.setPlaybackSpeedContainerClassFieldReferenceRef
import app.silva.patches.youtube.video.information.setPlaybackSpeedContainerClassFieldReferenceClassTypeRef
import app.silva.patches.youtube.video.information.setPlaybackSpeedMethodReferenceRef
...
internal val rememberPlaybackSpeedPatch = bytecodePatch {
    ...
    execute {
        settingsMenuVideoSpeedGroup.addAll(
            listOf(
                ListPreference(
                    key = "silva_playback_speed_default",
                    // Entries and values are set by the extension code based on the actual speeds available.
                    entriesKey = null,
                    entryValuesKey = null,
                    tag = "app.silva.extension.youtube.settings.preference.CustomVideoSpeedListPreference"
                ),
                SwitchPreference("silva_remember_playback_speed_last_selected"),
                SwitchPreference("silva_remember_playback_speed_last_selected_toast")
            )
        )
