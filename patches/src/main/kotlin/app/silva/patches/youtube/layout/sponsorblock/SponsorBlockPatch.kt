package app.silva.patches.youtube.layout.sponsorblock
...
import app.silva.patches.youtube.video.information.videoTimeHook
    ...
    execute {
        PreferenceScreen.SPONSORBLOCK.addPreferences(
            ...
            PreferenceCategory(
                ...
                tag = "app.silva.extension.youtube.sponsorblock.ui.SponsorBlockPreferenceGroup"
            ),
            PreferenceCategory(
                key = "silva_sb_stats",
                sorting = PreferenceScreenPreference.Sorting.UNSORTED,
                preferences = emptySet(), // Preferences are added by custom class at runtime.
                tag = "app.silva.extension.youtube.sponsorblock.ui.SponsorBlockStatsPreferenceCategory"
            ),
            PreferenceCategory(
                key = "silva_sb_about",
                sorting = PreferenceScreenPreference.Sorting.UNSORTED,
                preferences = setOf(
                    NonInteractivePreference(
                        key = "silva_sb_about_api",
                        tag = "app.silva.extension.youtube.sponsorblock.ui.SponsorBlockAboutPreference",
                        selectable = true,
                    )
                )
            )
        ...
        arrayOf(
            ResourceGroup(
                "layout",
                "silva_sb_inline_sponsor_overlay.xml",
                "silva_sb_new_segment.xml",
                "silva_sb_skip_sponsor_button.xml",
            ),
            ResourceGroup(
                "drawable",
                "silva_sb_adjust.xml",
                "silva_sb_backward.xml",
                "silva_sb_compare.xml",
                "silva_sb_edit.xml",
                "silva_sb_forward.xml",
                "silva_sb_logo.xml",
                "silva_sb_logo_bold.xml",
                "silva_sb_publish.xml",
                "silva_sb_voting.xml",
            )
        ...
        addTopControl(
            "sponsorblock",
            "@+id/silva_sb_voting_button",
            "@+id/silva_sb_create_segment_button"
        )
    }
}
