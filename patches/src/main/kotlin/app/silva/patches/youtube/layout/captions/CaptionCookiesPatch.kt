...
internal val captionCookiesPatch = bytecodePatch(
    ...
    execute {
        settingsMenuCaptionGroup.addAll(listOf(
            SwitchPreference("silva_set_caption_cookies"),
            TextPreference(
                "silva_caption_cookies",
                inputType = InputType.TEXT_MULTI_LINE
            ),
            NonInteractivePreference(
                key = "silva_get_caption_cookies",
                tag = "app.silva.extension.youtube.settings.preference.GetCaptionCookiesPreference",
            )
        ))
