...
package app.silva.patches.youtube.video.speed.custom
...
import app.silva.patches.youtube.misc.playservice.is_21_02_or_greater
import app.silva.patches.youtube.misc.playservice.is_21_12_or_greater
...
import app.silva.patches.youtube.video.speed.settingsMenuVideoSpeedGroup
...
private const val FILTER_CLASS_DESCRIPTOR =
    "Lapp/silva/extension/youtube/patches/components/PlaybackSpeedMenuFilter;"

internal const val EXTENSION_CLASS_DESCRIPTOR =
    "Lapp/silva/extension/youtube/patches/playback/speed/CustomPlaybackSpeedPatch;"
...
internal val customPlaybackSpeedPatch = bytecodePatch(
    ...
    execute {
        settingsMenuVideoSpeedGroup.addAll(
            listOf(
                SwitchPreference("silva_custom_speed_menu"),
                SwitchPreference("silva_restore_old_speed_menu"),
                TextPreference(
                    "silva_custom_playback_speeds",
        ...
        if (is_19_47_or_greater) {
            settingsMenuVideoSpeedGroup.add(
                TextPreference("silva_speed_tap_and_hold", inputType = InputType.NUMBER_DECIMAL),
            )
        }
