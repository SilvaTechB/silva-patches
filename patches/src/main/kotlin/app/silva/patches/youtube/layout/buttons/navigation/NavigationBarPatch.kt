...
package app.silva.patches.youtube.layout.buttons.navigation
...
import app.silva.patches.shared.misc.fix.proto.immutableMethodRef
import app.silva.patches.shared.misc.fix.proto.mutableCopyMethodRef
import app.silva.patches.shared.misc.fix.proto.parseByteArrayMethod
...
import app.silva.patches.youtube.misc.contexthook.addOSNameHook
...
import app.silva.patches.youtube.misc.navigation.hookNavigationButtonCreated
import app.silva.patches.youtube.misc.navigation.navigationBarHookPatch
import app.silva.patches.youtube.misc.playservice.is_19_25_or_greater
import app.silva.patches.youtube.misc.playservice.is_20_15_or_greater
import app.silva.patches.youtube.misc.playservice.is_20_31_or_greater
import app.silva.patches.youtube.misc.playservice.is_20_46_or_greater
...
import app.silva.patches.youtube.misc.toolbar.hookToolBar
import app.silva.patches.youtube.misc.toolbar.toolBarHookPatch
import app.silva.patches.youtube.shared.ActionBarSearchResultsFingerprint
...
import app.silva.util.getFreeRegisterProvider
...
val navigationBarPatch = bytecodePatch(
    ...
    execute {
        val navPreferences = mutableSetOf(
            SwitchPreference("silva_hide_home_button"),
            SwitchPreference("silva_hide_shorts_button"),
            SwitchPreference("silva_hide_create_button"),
            SwitchPreference("silva_hide_subscriptions_button"),
            SwitchPreference("silva_hide_notifications_button"),
            SwitchPreference("silva_show_search_button"),
            ListPreference("silva_show_search_button_index"),
            SwitchPreference("silva_show_settings_button"),
            ListPreference("silva_show_settings_button_index"),
            SwitchPreference("silva_show_settings_button_type"),
            SwitchPreference("silva_swap_create_with_notifications_button"),
            SwitchPreference("silva_hide_navigation_button_labels"),
            SwitchPreference("silva_narrow_navigation_buttons"),
            SwitchPreference("silva_hide_navigation_bar"),
        )

        if (is_19_25_or_greater) {
            navPreferences += SwitchPreference("silva_disable_translucent_navigation_bar_light")
            navPreferences += SwitchPreference("silva_disable_translucent_navigation_bar_dark")

            PreferenceScreen.GENERAL.addPreferences(
                SwitchPreference("silva_disable_translucent_status_bar")
            )

            if (is_20_15_or_greater) {
                navPreferences += SwitchPreference("silva_navigation_bar_animations")
            }
        }

        PreferenceScreen.GENERAL.addPreferences(
            PreferenceScreenPreference(
                key = "silva_navigation_buttons_screen",
        ...
        val toolbarPreferences = mutableSetOf(
            SwitchPreference("silva_hide_toolbar_create_button"),
            SwitchPreference("silva_hide_toolbar_microphone_button"),
            SwitchPreference("silva_hide_toolbar_notification_button"),
            SwitchPreference("silva_hide_toolbar_search_button"),
            SwitchPreference("silva_show_toolbar_settings_button"),
            ListPreference("silva_show_toolbar_settings_button_index"),
            SwitchPreference("silva_show_toolbar_settings_button_type")
        )
        if (!is_20_31_or_greater) {
            toolbarPreferences += SwitchPreference("silva_wide_searchbar")
        }

        PreferenceScreen.GENERAL.addPreferences(
            PreferenceScreenPreference(
                key = "silva_toolbar_screen",
                sorting = Sorting.UNSORTED,
