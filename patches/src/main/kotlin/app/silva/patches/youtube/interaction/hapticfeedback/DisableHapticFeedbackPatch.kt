package app.silva.patches.youtube.interaction.hapticfeedback
...
import app.silva.patches.all.misc.transformation.IMethodCall
import app.silva.patches.all.misc.transformation.filterMapInstruction35c
    ...
    execute {
        PreferenceScreen.PLAYER.addPreferences(
            PreferenceScreenPreference(
                "silva_disable_haptic_feedback",
                preferences = setOf(
                    SwitchPreference("silva_disable_haptic_feedback_chapters"),
                    SwitchPreference("silva_disable_haptic_feedback_precise_seeking"),
                    SwitchPreference("silva_disable_haptic_feedback_seek_undo"),
                    SwitchPreference("silva_disable_haptic_feedback_tap_and_hold"),
                    SwitchPreference("silva_disable_haptic_feedback_zoom"),
                )
            )
        )
