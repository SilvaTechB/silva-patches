...
package app.silva.patches.youtube.layout.formfactor
...
import app.silva.patches.youtube.misc.contexthook.addClientFormFactorHook
...
val changeFormFactorPatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.GENERAL.addPreferences(
            ListPreference("silva_change_form_factor")
        )
