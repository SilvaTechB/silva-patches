...
package app.silva.patches.youtube.video.speed
...
import app.silva.patches.youtube.video.speed.button.playbackSpeedButtonPatch
import app.silva.patches.youtube.video.speed.custom.customPlaybackSpeedPatch
import app.silva.patches.youtube.video.speed.remember.rememberPlaybackSpeedPatch
...
val playbackSpeedPatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.VIDEO.addPreferences(
            PreferenceCategory(
                key = "silva_zz_video_key", // Dummy key to force the speed settings last.
                titleKey = null,
