package app.silva.patches.youtube.layout.theme
...
import app.silva.patches.shared.layout.theme.THEME_COLOR_OPTION_DESCRIPTION
import app.silva.patches.shared.layout.theme.THEME_DEFAULT_DARK_COLOR_NAMES
import app.silva.patches.shared.layout.theme.THEME_DEFAULT_LIGHT_COLOR_NAMES
...
import app.silva.patches.youtube.misc.playservice.is_19_47_or_greater
import app.silva.patches.youtube.misc.playservice.is_20_02_or_greater
import app.silva.patches.youtube.misc.playservice.is_21_06_or_greater
...
import app.silva.util.forEachChildElement
import app.silva.util.insertLiteralOverride
import com.android.tools.smali.dexlib2.iface.instruction.OneRegisterInstruction
import com.android.tools.smali.dexlib2.iface.instruction.TwoRegisterInstruction
import org.w3c.dom.Element

private const val EXTENSION_CLASS_DESCRIPTOR = "Lapp/silva/extension/youtube/patches/theme/ThemePatch;"
...
val themePatch = baseThemePatch(
    ...
    block = {
        ...
        val themeResourcePatch = resourcePatch {
            ...
            execute {
                ...
                val splashBackgroundColorKey = "silva_splash_background_color"
                addColorResource(
    ...
    executeBlock = {
        PreferenceScreen.GENERAL.addPreferences(
            SwitchPreference("silva_gradient_loading_screen")
        )

        val preferences = mutableSetOf(
            SwitchPreference("silva_seekbar_custom_color"),
            TextPreference(
                "silva_seekbar_custom_color_primary",
                tag = "app.silva.extension.shared.settings.preference.ColorPickerPreference",
                inputType = InputType.TEXT_CAP_CHARACTERS
            ),
            TextPreference(
                "silva_seekbar_custom_color_accent",
                tag = "app.silva.extension.shared.settings.preference.ColorPickerPreference",
                inputType = InputType.TEXT_CAP_CHARACTERS
            )
        )
        ...
        if (is_19_47_or_greater) {
            PreferenceScreen.GENERAL.addPreferences(
                ListPreference("silva_splash_screen_animation_style")
            )
        }
