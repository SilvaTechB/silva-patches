    ...
    execute {
        settingsMenuCaptionGroup.add(
            if (is_20_26_or_greater) {
                ListPreference("silva_auto_captions_style")
            } else {
                ListPreference(
                    key = "silva_auto_captions_style",
                    entriesKey = "silva_auto_captions_style_legacy_entries",
                    entryValuesKey = "silva_auto_captions_style_legacy_entry_values"
                )
            }
        )
