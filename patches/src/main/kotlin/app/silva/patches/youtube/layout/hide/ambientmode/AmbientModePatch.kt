package app.silva.patches.youtube.layout.hide.ambientmode
    ...
    execute {
        PreferenceScreen.PLAYER.addPreferences(
            PreferenceScreenPreference(
                key = "silva_ambient_mode_screen",
                sorting = PreferenceScreenPreference.Sorting.UNSORTED,
                preferences = setOf(
                    SwitchPreference("silva_bypass_ambient_mode_restrictions"),
                    SwitchPreference("silva_disable_ambient_mode"),
                    SwitchPreference("silva_disable_fullscreen_ambient_mode"),
                )
            )
        )
