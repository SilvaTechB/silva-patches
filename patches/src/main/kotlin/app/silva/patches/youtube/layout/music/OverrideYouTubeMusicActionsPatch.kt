...
package app.silva.patches.youtube.layout.music
...
private const val EXTENSION_CLASS_DESCRIPTOR = "Lapp/silva/extension/youtube/patches/OverrideYouTubeMusicActionsPatch;"

private fun overrideYouTubeMusicManifestPatch() = resourcePatch{
    compatibleWith(COMPATIBILITY_YOUTUBE)

    execute {
        val targetPackage = "app.silva.android.apps.youtube.music"
    ...
    execute {
        PreferenceScreen.GENERAL.addPreferences(
            PreferenceCategory(
                ...
                preferences = setOf(
                    SwitchPreference(key = "silva_override_youtube_music_button"),
                    TextPreference(key = "silva_music_package_name")
                )
            )
        )
