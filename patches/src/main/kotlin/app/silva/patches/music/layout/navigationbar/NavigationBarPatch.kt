package app.silva.patches.music.layout.navigationbar
    ...
    execute {
        PreferenceScreen.GENERAL.addPreferences(
            PreferenceScreenPreference(
                key = "silva_music_navigation_bar_screen",
                sorting = PreferenceScreenPreference.Sorting.UNSORTED,
                preferences = setOf(
                    SwitchPreference("silva_music_hide_navigation_bar_home_button"),
                    SwitchPreference("silva_music_hide_navigation_bar_samples_button"),
                    SwitchPreference("silva_music_hide_navigation_bar_explore_button"),
                    SwitchPreference("silva_music_hide_navigation_bar_library_button"),
                    SwitchPreference("silva_music_hide_navigation_bar_upgrade_button"),
                    SwitchPreference("silva_music_hide_navigation_bar"),
                    SwitchPreference("silva_music_hide_navigation_bar_labels"),
                )
            )
        )
