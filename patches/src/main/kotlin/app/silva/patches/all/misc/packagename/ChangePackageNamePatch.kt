...
package app.silva.patches.all.misc.packagename
...
import app.silva.util.asSequence
import app.silva.util.findInstructionIndicesReversed
    ...
    dependsOn(bytecodePatch {
        execute {
            try {
                ...
                // TODO: Eventually remove this check. Early versions of Silva Manager
                //       may not auto update if GitHub non auth API blocks the user ip.
                throw RuntimeException(
                    "\n\n#####################################\n\n" +
                            "Your Silva app is outdated. Please manually update Morphe " +
