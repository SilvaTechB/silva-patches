...
import static app.silva.extension.shared.Utils.runOnMainThreadDelayed;
    ...
    public static void onCreate(Activity activity) {
        ...
        runOnMainThreadDelayed(() -> {
            ...
            Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                    activity,
                    str("silva_settings_restart_title"),   // Title.
                    str("silva_restart_first_run"),        // Message.
                    null,                                       // No EditText.
                    str("silva_settings_restart"),         // OK button text.
