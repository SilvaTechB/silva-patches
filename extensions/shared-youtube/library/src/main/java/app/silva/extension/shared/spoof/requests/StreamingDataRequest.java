...
package app.silva.extension.shared.spoof.requests;

import static app.silva.extension.shared.StringRef.str;
import static app.silva.extension.shared.Utils.isNotEmpty;
import static app.silva.extension.shared.spoof.js.JavaScriptEngineSupport.supportsJavaScriptEngine;
import static app.silva.extension.shared.spoof.js.JavaScriptManager.getDeobfuscatedStreamingData;
import static app.silva.extension.shared.spoof.js.JavaScriptManager.getJavaScriptHash;
import static app.silva.extension.shared.spoof.js.JavaScriptManager.getJavaScriptVariant;
import static app.silva.extension.shared.spoof.requests.PlayerRoutes.GET_PLAYER_STREAMING_DATA;
import static app.silva.extension.shared.spoof.requests.PlayerRoutes.GET_REEL_STREAMING_DATA;
...
import app.silva.extension.shared.innertube.PlayerResponseOuterClass.PlayerResponse;
import app.silva.extension.shared.innertube.PlayerResponseOuterClass.StreamingData;
import app.silva.extension.shared.innertube.ReelItemWatchResponseOuterClass.ReelItemWatchResponse;
...
public class StreamingDataRequest {
    ...
    private static byte[] fetch(String videoId, Map<String, String> playerHeaders) {
        ...
        handleConnectionError(str("silva_spoof_video_streams_no_clients_toast"), null, true);
        ...
        if (preferredClient != ClientType.ANDROID_VR_1_64 && preferredClient != ClientType.ANDROID_VR_1_65
            ...
            handleConnectionError(str("silva_spoof_video_streams_no_clients_suggest_vr_toast"), null, true);
        }
        return null;
    }
