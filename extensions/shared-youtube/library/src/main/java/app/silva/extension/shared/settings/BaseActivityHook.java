...
import app.silva.extension.shared.settings.preference.ToolbarPreferenceFragment;
...
public abstract class BaseActivityHook extends Activity {
    ...
    public static final String SILVA_SETTINGS_INTENT = "silva_settings_intent";
    private static final int ID_SILVA_SETTINGS_FRAGMENTS =
            getIdentifierOrThrow(ResourceType.ID, "silva_settings_fragments");
    private static final int ID_SILVA_TOOLBAR_PARENT =
            getIdentifierOrThrow(ResourceType.ID, "silva_toolbar_parent");
    public static final int LAYOUT_SILVA_SETTINGS_WITH_TOOLBAR =
            getIdentifierOrThrow(ResourceType.LAYOUT, "silva_settings_with_toolbar");
    private static final int STRING_SILVA_SETTINGS_TITLE =
            getIdentifierOrThrow(ResourceType.STRING, "silva_settings_title");
    ...
    public static void initialize(BaseActivityHook hook, Activity activity) {
        try {
            ...
            if (!SILVA_SETTINGS_INTENT.equals(dataString)) {
            ...
            activity.getFragmentManager()
                    .beginTransaction()
                    .replace(ID_SILVA_SETTINGS_FRAGMENTS, fragment)
                    .commit();
        } catch (Exception ex) {
    ...
    public static Context getAttachBaseContext(Context original) {
        AppLanguage language = BaseSettings.SILVA_LANGUAGE.get();
    ...
    protected void createToolbar(Activity activity, PreferenceFragment fragment) {
        ...
        ViewGroup toolBarParent = activity.findViewById(ID_SILVA_TOOLBAR_PARENT);
        ViewGroup dummyToolbar = Utils.getChildViewByResourceName(toolBarParent, "silva_toolbar");
        ...
        toolbar.setTitle(STRING_SILVA_SETTINGS_TITLE);
    ...
    protected int getContentViewResourceId() {
        return LAYOUT_SILVA_SETTINGS_WITH_TOOLBAR;
    }
