package app.silva.extension.shared.settings.search;
...
import app.silva.extension.shared.settings.AppLanguage;
import app.silva.extension.shared.settings.BaseSettings;
import app.silva.extension.shared.settings.Setting;
import app.silva.extension.shared.settings.preference.ColorPickerPreference;
import app.silva.extension.shared.settings.preference.CustomDialogListPreference;
import app.silva.extension.shared.settings.preference.NoTitlePreferenceCategory;
...
public abstract class BaseSearchViewController {
    ...
    protected static final int ID_SILVA_SEARCH_VIEW = getIdentifierOrThrow(
            ResourceType.ID, "silva_search_view");
    protected static final int ID_SILVA_SEARCH_VIEW_CONTAINER = getIdentifierOrThrow(
            ResourceType.ID, "silva_search_view_container");
    protected static final int ID_ACTION_SEARCH = getIdentifierOrThrow(
            ResourceType.ID, "action_search");
    protected static final int ID_SILVA_SETTINGS_FRAGMENTS = getIdentifierOrThrow(
            ResourceType.ID, "silva_settings_fragments");
    private static final int DRAWABLE_SILVA_SETTINGS_SEARCH_ICON = getIdentifierOrThrow(
            ResourceType.DRAWABLE, "silva_settings_search_icon");
    private static final int DRAWABLE_SILVA_SETTINGS_SEARCH_ICON_BOLD = getIdentifierOrThrow(
            ResourceType.DRAWABLE, "silva_settings_search_icon_bold");
    protected static final int MENU_SILVA_SEARCH_MENU = getIdentifierOrThrow(
            ResourceType.MENU, "silva_search_menu");
    ...
    public static int getSearchIcon() {
        return Utils.appIsUsingBoldIcons()
                ? DRAWABLE_SILVA_SETTINGS_SEARCH_ICON_BOLD
                : DRAWABLE_SILVA_SETTINGS_SEARCH_ICON;
    }
    ...
    private void initializeSearchView() {
        ...
        searchView = activity.findViewById(ID_SILVA_SEARCH_VIEW);
        ...
        searchContainer = activity.findViewById(ID_SILVA_SEARCH_VIEW_CONTAINER);

        // Set background and query hint.
        searchView.setBackground(createBackgroundDrawable());
        searchView.setQueryHint(str("silva_settings_search_hint"));
        ...
        AppLanguage appLanguage = BaseSettings.SILVA_LANGUAGE.get();
    ...
    private void initializeOverlayContainer() {
        ...
        FrameLayout mainContainer = activity.findViewById(ID_SILVA_SETTINGS_FRAGMENTS);
    ...
    protected void setupToolbarMenu() {
        toolbar.inflateMenu(MENU_SILVA_SEARCH_MENU);
    ...
    protected void filterAndShowResults(String query) {
        ...
        if (filteredSearchItems.isEmpty()) {
            ...
            noResultsPreference.setTitle(str("silva_settings_search_no_results_title", query));
            noResultsPreference.setSummary(str("silva_settings_search_no_results_summary"));
