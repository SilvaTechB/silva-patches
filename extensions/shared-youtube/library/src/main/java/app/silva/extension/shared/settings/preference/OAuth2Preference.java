...
import static app.silva.extension.shared.oauth2.requests.OAuth2Requester.isActivationCodeDataAvailable;
...
import app.silva.extension.shared.oauth2.object.AccessTokenData;
import app.silva.extension.shared.oauth2.object.ActivationCodeData;
import app.silva.extension.shared.oauth2.requests.OAuth2Requester;
import app.silva.extension.shared.settings.SharedYouTubeSettings;
import app.silva.extension.shared.spoof.SpoofVideoStreamsPatch;
...
public abstract class OAuth2Preference extends Preference implements Preference.OnPreferenceClickListener {
    ...
    protected void updateUI(boolean currentlySignedIn) {
        ...
        if (isSettingEnabled) {
            summaryKey = currentlySignedIn
                    ? "silva_spoof_video_streams_sign_in_android_vr_about_summary_signed_in"
                    : "silva_spoof_video_streams_sign_in_android_vr_about_summary";
        } else {
            summaryKey = "silva_spoof_video_streams_sign_in_android_vr_about_summary_disabled";
        }
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        if (isRefreshTokenSaved()) {
            titleKey = "silva_spoof_video_streams_sign_in_android_vr_about_summary_signed_in";
            messageKey = "silva_spoof_video_streams_sign_in_android_vr_success_dialog_message";
            okButtonTextKey = "silva_spoof_video_streams_sign_in_android_vr_dialog_reset";
            okButtonRunnable = () -> {
            ...
            titleKey = "silva_spoof_video_streams_sign_in_android_vr_dialog_title";
            messageKey = "silva_spoof_video_streams_sign_in_android_vr_dialog_not_signed_in_message";
            okButtonTextKey = "silva_spoof_video_streams_sign_in_android_vr_dialog_continue";
    ...
    private void showActivationCodeDialog() {
        ...
        Utils.runOnBackgroundThread(() -> {
            ...
            if (activationCodeData == null) {
                Utils.showToastLong(str("silva_spoof_video_streams_sign_in_android_vr_toast_get_activation_code_failed"));
                return;
            }
            ...
            Utils.runOnMainThread(() -> {
                ...
                CustomDialog.create(
                        context,
                        // Title.
                        str("silva_spoof_video_streams_sign_in_android_vr_activation_code_dialog_title"),
                        // Message.
                        str("silva_spoof_video_streams_sign_in_android_vr_activation_code_dialog_message", userCode),
                        // No EditText.
                        null,
                        // OK button text.
                        str("silva_spoof_video_streams_sign_in_android_vr_activation_code_dialog_open_website"),
                        // OK button action.
                        () -> {
        ...
        Utils.runOnBackgroundThread(() -> {
            ...
            Utils.runOnMainThread(() -> {
                if (accessTokenData == null) {
                    ...
                    if (reachedMaxGetTokenAttempts) {
                        Utils.showToastLong(str("silva_spoof_video_streams_sign_in_android_vr_toast_get_authorization_code_failed"));
                    }
                    return;
                }
                ...
                CustomDialog.create(
                        context,
                        // Title.
                        str("silva_spoof_video_streams_sign_in_android_vr_success_dialog_title"),
                        // Message.
                        BulletPointPreference.formatIntoBulletPoints(
                                str("silva_spoof_video_streams_sign_in_android_vr_success_dialog_message")
                        ),
                        // No EditText.
                        null,
                        // OK button text.
