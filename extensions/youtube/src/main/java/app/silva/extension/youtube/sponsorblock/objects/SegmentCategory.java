package app.silva.extension.youtube.sponsorblock.objects;

import static app.silva.extension.shared.StringRef.sf;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_FILLER;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_FILLER_COLOR;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_HIGHLIGHT;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_HIGHLIGHT_COLOR;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_HOOK;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_HOOK_COLOR;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_INTERACTION;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_INTERACTION_COLOR;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_INTRO;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_INTRO_COLOR;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_MUSIC_OFFTOPIC;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_MUSIC_OFFTOPIC_COLOR;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_OUTRO;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_OUTRO_COLOR;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_PREVIEW;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_PREVIEW_COLOR;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_SELF_PROMO;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_SELF_PROMO_COLOR;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_SPONSOR;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_SPONSOR_COLOR;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_UNSUBMITTED;
import static app.silva.extension.youtube.settings.Settings.SB_CATEGORY_UNSUBMITTED_COLOR;
...
import app.silva.extension.shared.StringRef;
...
public enum SegmentCategory {
    SPONSOR("sponsor", sf("silva_sb_segments_sponsor"), sf("silva_sb_segments_sponsor_sum"), sf("silva_sb_skip_button_sponsor"), sf("silva_sb_skipped_sponsor"),
            SB_CATEGORY_SPONSOR, SB_CATEGORY_SPONSOR_COLOR),
    SELF_PROMO("selfpromo", sf("silva_sb_segments_selfpromo"), sf("silva_sb_segments_selfpromo_sum"), sf("silva_sb_skip_button_selfpromo"), sf("silva_sb_skipped_selfpromo"),
            SB_CATEGORY_SELF_PROMO, SB_CATEGORY_SELF_PROMO_COLOR),
    INTERACTION("interaction", sf("silva_sb_segments_interaction"), sf("silva_sb_segments_interaction_sum"), sf("silva_sb_skip_button_interaction"), sf("silva_sb_skipped_interaction"),
            SB_CATEGORY_INTERACTION, SB_CATEGORY_INTERACTION_COLOR),
    /**
     * Unique category that is treated differently than the rest.
     */
    HIGHLIGHT("poi_highlight", sf("silva_sb_segments_highlight"), sf("silva_sb_segments_highlight_sum"), sf("silva_sb_skip_button_highlight"), sf("silva_sb_skipped_highlight"),
            SB_CATEGORY_HIGHLIGHT, SB_CATEGORY_HIGHLIGHT_COLOR),
    INTRO("intro", sf("silva_sb_segments_intro"), sf("silva_sb_segments_intro_sum"),
            sf("silva_sb_skip_button_intro_beginning"), sf("silva_sb_skip_button_intro_middle"), sf("silva_sb_skip_button_intro_end"),
            sf("silva_sb_skipped_intro_beginning"), sf("silva_sb_skipped_intro_middle"), sf("silva_sb_skipped_intro_end"),
            SB_CATEGORY_INTRO, SB_CATEGORY_INTRO_COLOR),
    OUTRO("outro", sf("silva_sb_segments_outro"), sf("silva_sb_segments_outro_sum"), sf("silva_sb_skip_button_outro"), sf("silva_sb_skipped_outro"),
            SB_CATEGORY_OUTRO, SB_CATEGORY_OUTRO_COLOR),
    PREVIEW("preview", sf("silva_sb_segments_preview"), sf("silva_sb_segments_preview_sum"),
            sf("silva_sb_skip_button_preview_beginning"), sf("silva_sb_skip_button_preview_middle"), sf("silva_sb_skip_button_preview_end"),
            sf("silva_sb_skipped_preview_beginning"), sf("silva_sb_skipped_preview_middle"), sf("silva_sb_skipped_preview_end"),
            SB_CATEGORY_PREVIEW, SB_CATEGORY_PREVIEW_COLOR),
    HOOK("hook", sf("silva_sb_segments_hook"), sf("silva_sb_segments_hook_sum"), sf("silva_sb_skip_button_hook"), sf("silva_sb_skipped_hook"),
            SB_CATEGORY_HOOK, SB_CATEGORY_HOOK_COLOR),
    FILLER("filler", sf("silva_sb_segments_filler"), sf("silva_sb_segments_filler_sum"), sf("silva_sb_skip_button_filler"), sf("silva_sb_skipped_filler"),
            SB_CATEGORY_FILLER, SB_CATEGORY_FILLER_COLOR),
    MUSIC_OFFTOPIC("music_offtopic", sf("silva_sb_segments_nomusic"), sf("silva_sb_segments_nomusic_sum"), sf("silva_sb_skip_button_nomusic"), sf("silva_sb_skipped_nomusic"),
            SB_CATEGORY_MUSIC_OFFTOPIC, SB_CATEGORY_MUSIC_OFFTOPIC_COLOR),
    UNSUBMITTED("unsubmitted", StringRef.empty, StringRef.empty, sf("silva_sb_skip_button_unsubmitted"), sf("silva_sb_skipped_unsubmitted"),
            SB_CATEGORY_UNSUBMITTED, SB_CATEGORY_UNSUBMITTED_COLOR);

    private static final StringRef skipSponsorTextCompact = sf("silva_sb_skip_button_compact");
    private static final StringRef skipSponsorTextCompactHighlight = sf("silva_sb_skip_button_compact_highlight");
