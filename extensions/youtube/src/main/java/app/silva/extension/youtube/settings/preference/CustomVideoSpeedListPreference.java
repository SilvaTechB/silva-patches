...
import app.silva.extension.youtube.patches.playback.speed.CustomPlaybackSpeedPatch;
...
public final class CustomVideoSpeedListPreference extends CustomDialogListPreference {

    {
        ...
        preferenceListEntries[0] = sf("silva_custom_playback_speeds_auto").toString();
