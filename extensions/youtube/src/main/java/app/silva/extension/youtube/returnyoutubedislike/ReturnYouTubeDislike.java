package app.silva.extension.youtube.returnyoutubedislike;
...
import app.silva.extension.youtube.returnyoutubedislike.requests.RYDVoteData;
    ...
    private static SpannableString createDislikeSpan(@NonNull Spanned oldSpannable,
        ...
        if (!Utils.containsNumber(oldLikes)) {
            ...
            if (!Settings.RYD_ESTIMATED_LIKE.get()) {
                ...
                String hiddenMessageString = str("silva_ryd_video_likes_hidden_by_video_owner");
        ...
        try {
            ...
            if (votingData == null) {
                ...
                ReturnYouTubeDislikeAPI.handleConnectionError(
                        str("silva_ryd_failure_connection_timeout"),
    ...
    public void sendVote(@NonNull Vote vote) {
        ...
        try {
            ...
            if (isShort != currentType.isNoneHiddenOrMinimized()) {
                ...
                Utils.showToastLong(str("silva_ryd_failure_ryd_enabled_while_playing_video_then_user_voted"));
                return;
            }
