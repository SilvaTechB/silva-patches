...
import static app.silva.extension.youtube.patches.LayoutReloadObserverPatch.isActionBarVisible;
...
import app.silva.extension.youtube.shared.EngagementPanel;
        ...
        if (contentType == FilterContentType.PATH) {
            ...
            if (matchedGroup == shortsCompactFeedVideo) {
                return shouldHideShortsFeedItems()
                        ...
                        // See: https://github.com/SilvaTechB/silva-patches/issues/773.
                        //
