...
import static app.silva.extension.shared.settings.preference.CustomDialogListPreference.ID_SILVA_CHECK_ICON;
import static app.silva.extension.shared.settings.preference.CustomDialogListPreference.ID_SILVA_CHECK_ICON_PLACEHOLDER;
import static app.silva.extension.shared.settings.preference.CustomDialogListPreference.ID_SILVA_ITEM_TEXT;
import static app.silva.extension.shared.settings.preference.CustomDialogListPreference.LAYOUT_SILVA_CUSTOM_LIST_ITEM_CHECKED;
import static app.silva.extension.youtube.patches.VideoInformation.AUTOMATIC_VIDEO_QUALITY_VALUE;
import static app.silva.extension.youtube.patches.VideoInformation.isPremiumVideoQuality;
import static app.silva.extension.youtube.videoplayer.PlayerControlButton.fadeInDuration;
import static app.silva.extension.youtube.videoplayer.PlayerControlButton.getDialogBackgroundColor;
...
import app.silva.extension.shared.ui.SheetBottomDialog;
import app.silva.extension.youtube.patches.VideoInformation;
import app.silva.extension.youtube.patches.VideoInformation.VideoQualityInterface;
import app.silva.extension.youtube.patches.playback.quality.RememberVideoQualityPatch;
    ...
    public static void initializeButton(View controlsView) {
        try {
            instance = new PlayerControlButton(
                    controlsView,
                    "silva_video_quality_dialog_button_container",
                    "silva_video_quality_dialog_button",
                    "silva_video_quality_dialog_button_text",
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(getContext()).inflate(
                        LAYOUT_SILVA_CUSTOM_LIST_ITEM_CHECKED,
                        parent,
                        false
                );
                viewHolder = new ViewHolder();
                viewHolder.checkIcon = convertView.findViewById(ID_SILVA_CHECK_ICON);
                viewHolder.placeholder = convertView.findViewById(ID_SILVA_CHECK_ICON_PLACEHOLDER);
                viewHolder.textView = convertView.findViewById(ID_SILVA_ITEM_TEXT);
