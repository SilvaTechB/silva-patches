    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        if (Utils.isNotEmpty(newValue)) {
            ...
            if (!newValue.equals(cookieString)) {
                ...
                Utils.showToastShort(str("silva_get_caption_cookies_success"));
            } else {
                Utils.showToastShort(str("silva_get_caption_cookies_duplicate"));
            }
        } else {
            Utils.showToastShort(str("silva_get_caption_cookies_failed"));
        }
