...
package app.silva.extension.youtube.shared;

import static app.silva.extension.youtube.patches.spoof.SpoofAppVersionPatch.isSpoofingToLessThan;
import static app.silva.extension.youtube.shared.NavigationBar.NavigationButton.CREATE;
...
public final class NavigationBar {
    ...
    private static final int fillBellCairoBlack = ResourceUtils.getIdentifier(ResourceType.DRAWABLE,
            VersionCheckPatch.IS_20_31_OR_GREATER && !isSpoofingToLessThan("20.31.00")
                    ...
                    : "silva_fill_bell_cairo_black_24"
    );
