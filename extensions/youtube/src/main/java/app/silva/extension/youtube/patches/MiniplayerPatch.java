...
import static app.silva.extension.youtube.patches.MiniplayerPatch.MiniplayerType.DEFAULT;
import static app.silva.extension.youtube.patches.MiniplayerPatch.MiniplayerType.DISABLED;
import static app.silva.extension.youtube.patches.MiniplayerPatch.MiniplayerType.MINIMAL;
import static app.silva.extension.youtube.patches.MiniplayerPatch.MiniplayerType.MODERN_1;
import static app.silva.extension.youtube.patches.MiniplayerPatch.MiniplayerType.MODERN_2;
import static app.silva.extension.youtube.patches.MiniplayerPatch.MiniplayerType.MODERN_3;
import static app.silva.extension.youtube.patches.MiniplayerPatch.MiniplayerType.MODERN_4;
import static app.silva.extension.youtube.patches.VersionCheckPatch.IS_19_20_OR_GREATER;
import static app.silva.extension.youtube.patches.VersionCheckPatch.IS_19_21_OR_GREATER;
import static app.silva.extension.youtube.patches.VersionCheckPatch.IS_19_26_OR_GREATER;
import static app.silva.extension.youtube.patches.VersionCheckPatch.IS_19_29_OR_GREATER;
...
public final class MiniplayerPatch {
    ...
    static {
        ...
        if (dipWidth < WIDTH_DIP_MIN || dipWidth > WIDTH_DIP_MAX) {
            Utils.showToastLong(str("silva_miniplayer_width_dip_invalid_toast",
    ...
    static {
        ...
        if (opacity < 0 || opacity > 100) {
            Utils.showToastLong(str("silva_miniplayer_opacity_invalid_toast"));
