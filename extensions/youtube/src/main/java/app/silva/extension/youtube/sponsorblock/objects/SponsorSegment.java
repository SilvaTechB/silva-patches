...
public class SponsorSegment implements Comparable<SponsorSegment> {
    ...
    public enum SegmentVote {
        UPVOTE(sf("silva_sb_vote_upvote"), 1,false),
        DOWNVOTE(sf("silva_sb_vote_downvote"), 0, true),
        CATEGORY_CHANGE(sf("silva_sb_vote_category"), -1, true); // ApiVoteType is not used for category change.
