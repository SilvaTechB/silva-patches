...
package app.silva.extension.youtube.patches.playback.speed;
...
import app.silva.extension.youtube.patches.components.PlaybackSpeedMenuFilter;
...
public class CustomPlaybackSpeedPatch {
    ...
    private static void showInvalidCustomSpeedToast() {
        Utils.showToastLong(str("silva_custom_playback_speeds_invalid", PLAYBACK_SPEED_MAXIMUM));
    }
    ...
    private static float[] loadCustomSpeeds() {
        try {
            ...
            Utils.showToastShort(str("silva_custom_playback_speeds_parse_exception"));
            Settings.CUSTOM_PLAYBACK_SPEEDS.resetToDefault();
            return loadCustomSpeeds();
        }
    }
