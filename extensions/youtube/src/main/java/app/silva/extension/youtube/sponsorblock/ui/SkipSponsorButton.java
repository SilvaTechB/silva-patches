...
import static app.silva.extension.shared.ResourceUtils.getColor;
import static app.silva.extension.shared.ResourceUtils.getDimension;
import static app.silva.extension.shared.ResourceUtils.getDimensionPixelSize;
...
public class SkipSponsorButton extends FrameLayout {
    ...
    public SkipSponsorButton(Context context, AttributeSet attributeSet, int defStyleAttr, int defStyleRes) {
        ...
        LayoutInflater.from(context).inflate(ResourceUtils.getIdentifierOrThrow(context, ResourceType.LAYOUT, "silva_sb_skip_sponsor_button"), this, true);  // layout:skip_ad_button
        ...
        skipSponsorBtnContainer = Objects.requireNonNull(findViewById(ResourceUtils.getIdentifierOrThrow(
                context, ResourceType.ID, "silva_sb_skip_sponsor_button_container")));  // id:skip_ad_button_container
        ...
        skipSponsorTextView = Objects.requireNonNull(findViewById(ResourceUtils.getIdentifier(context, ResourceType.ID, "silva_sb_skip_sponsor_button_text")));  // id:skip_ad_button_text;
