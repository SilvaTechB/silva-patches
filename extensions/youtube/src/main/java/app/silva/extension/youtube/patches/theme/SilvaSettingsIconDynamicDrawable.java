package app.silva.extension.youtube.patches.theme;
...
public class SilvaSettingsIconDynamicDrawable extends Drawable {

    private Drawable icon;
    private Boolean lastKnownDarkMode;

    public SilvaSettingsIconDynamicDrawable() {
        updateIcon();
    }
    ...
    private void updateIcon() {
        ...
        if (lastKnownDarkMode == null || lastKnownDarkMode != isDarkMode) {
            ...
            String iconName = Utils.appIsUsingBoldIcons()
                    ? (isDarkMode ? "silva_settings_icon_bold_dark" : "silva_settings_icon_bold_light")
                    : (isDarkMode ? "silva_settings_icon_dark" : "silva_settings_icon_light");
