...
import static app.silva.extension.shared.Utils.equalsAny;
import static app.silva.extension.shared.Utils.hideViewUnderCondition;
import static app.silva.extension.shared.settings.BaseActivityHook.SILVA_SETTINGS_INTENT;
import static app.silva.extension.youtube.shared.NavigationBar.NavigationButton;
...
import app.silva.extension.youtube.innertube.GuideResponseOuterClass.Accessibility;
import app.silva.extension.youtube.innertube.GuideResponseOuterClass.AccessibilityData;
import app.silva.extension.youtube.innertube.GuideResponseOuterClass.ButtonRenderer;
import app.silva.extension.youtube.innertube.GuideResponseOuterClass.Buttons;
import app.silva.extension.youtube.innertube.GuideResponseOuterClass.PivotBarItemRenderer;
import app.silva.extension.youtube.innertube.IconOuterClass.Icon;
import app.silva.extension.youtube.innertube.IconOuterClass.YTIconType;
import app.silva.extension.youtube.settings.Settings;
import app.silva.extension.youtube.shared.NavigationBar;
...
public final class NavigationBarPatch {
            ...
            Utils.runOnMainThreadDelayed(() -> {
                if (imageView != null) {
                    ...
                    if (SHOW_TOOLBAR_SETTINGS_BUTTON_TYPE) {
                        imageView.setOnClickListener(NavigationBarPatch::openSilvaSettings);
    ...
    private static void openSilvaSettings(View view) {
        Activity activity = Utils.getActivity();
        Context context = activity != null ? activity : view.getContext();

        try {
            Intent intent = new Intent(Intent.ACTION_MAIN);
            intent.setData(Uri.parse(SILVA_SETTINGS_INTENT));
            intent.setPackage(context.getPackageName());
