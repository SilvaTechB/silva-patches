...
import static app.silva.extension.youtube.settings.Settings.ALT_THUMBNAIL_HOME;
import static app.silva.extension.youtube.settings.Settings.ALT_THUMBNAIL_LIBRARY;
import static app.silva.extension.youtube.settings.Settings.ALT_THUMBNAIL_PLAYER;
import static app.silva.extension.youtube.settings.Settings.ALT_THUMBNAIL_SEARCH;
import static app.silva.extension.youtube.settings.Settings.ALT_THUMBNAIL_SUBSCRIPTIONS;
        ...
        if (timeToResumeDeArrowAPICalls < now) {
            ...
            if (Settings.ALT_THUMBNAIL_DEARROW_CONNECTION_TOAST.get()) {
                String toastMessage = (statusCode != 0)
                        ? str("silva_alt_thumbnail_dearrow_error", statusCode)
                        : str("silva_alt_thumbnail_dearrow_error_generic");
