...
import static app.silva.extension.shared.StringRef.StringKeyLookup;
...
public class ExperimentalAppNoticePatch {
    ...
    private static final StringKeyLookup strings = new StringKeyLookup(
            Map.of("silva_experimental_app_version_dialog_title",
                    "🚨 Experimental Alert 🚨",

                    "silva_experimental_app_version_dialog_message",
                    """
                    ...
                    "silva_experimental_app_version_dialog_confirm",
                    "⚠️ I want experimental",

                    "silva_experimental_app_version_dialog_open_homepage",
                    "✅ I want stable"
            )
    );
    ...
    public static void showExperimentalNoticeIfNeeded(Activity activity) {
        try {
            ...
            Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                    activity,
                    getString("silva_experimental_app_version_dialog_title"), // Title.
                    Html.fromHtml(getString("silva_experimental_app_version_dialog_message", appVersionName, recommendedAppVersion)), // Message.
                    null, // No EditText.
                    getString("silva_experimental_app_version_dialog_open_homepage"), // OK button text.
                    () -> {
                    ...
                    getString("silva_experimental_app_version_dialog_confirm"), // Neutral button text.
