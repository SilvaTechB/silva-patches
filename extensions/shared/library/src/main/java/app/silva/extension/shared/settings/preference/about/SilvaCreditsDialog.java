...
import static app.silva.extension.shared.settings.preference.about.SilvaAboutPreference.WebLink;
...
class SilvaCreditsDialog extends Dialog {

    private static final List<WebLink> WORKS_LINKS_CURRENT = List.of(
            new WebLink("Morphe",
                    str("silva_settings_about_links_morphe"),
    ...
    private String createDialogHtml() {
        ...
        html.append(String.format("""
                        ...
                        """,
                StringRef.str("silva_settings_about_links_credits")
        ));
        ...
        html.append(String.format("""
                ...
                """, StringRef.str("silva_settings_about_contributors_current")));
        ...
        html.append(String.format("""
                <div class="credits-section">
                    <div class="section-label">%s</div>
                """, StringRef.str("silva_settings_about_contributors_prior")));
        ...
        html.append("<a href=\"").append(ABOUT_LICENSE.url).append("\" class=\"link-button\">")
                ...
                .append(str("silva_settings_about_links_licenses"))
                .append("</div>");
        html.append("</div>")
                .append("<span class=\"link-chevron\">&#x203A;</span>")
                .append("</a>");
    ...
    public SilvaCreditsDialog(Context context) {
        super(context);
