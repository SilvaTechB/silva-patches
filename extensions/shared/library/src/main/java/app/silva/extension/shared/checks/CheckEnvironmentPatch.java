package app.silva.extension.shared.checks;

import static app.silva.extension.shared.StringRef.str;
import static app.silva.extension.shared.checks.Check.debugAlwaysShowWarning;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_BOARD;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_BOOTLOADER;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_BRAND;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_CPU_ABI;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_CPU_ABI2;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_DEVICE;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_DISPLAY;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_FINGERPRINT;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_HARDWARE;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_HOST;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_ID;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_MANUFACTURER;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_MODEL;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_PRODUCT;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_RADIO;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_TAGS;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_TYPE;
import static app.silva.extension.shared.checks.PatchInfo.Build.PATCH_USER;
...
public final class CheckEnvironmentPatch {
    ...
    private enum InstallationType {
        ...
        MANAGER("app.silva.manager",
                "app.silva.manager.debug");
    ...
    private static class CheckExpectedInstaller extends Check {
        ...
        protected String failureReason() {
            return str("silva_check_environment_manager_not_expected_installer");
        }
    ...
    private static class CheckWasPatchedOnSameDevice extends Check {
        ...
        @Override
        protected String failureReason() {
            return str("silva_check_environment_not_same_patching_device");
        }
    ...
    private static class CheckIsNearPatchTime extends Check {
        ...
        protected String failureReason() {
            if (durationBetweenPatchingAndInstallation < 0) {
                ...
                return str("silva_check_environment_not_near_patch_time_invalid");
            }
            ...
            if (daysSincePatching > 1) { // Use over 1 day to avoid singular vs plural strings.
                return str("silva_check_environment_not_near_patch_time_days", daysSincePatching);
            }

            return str("silva_check_environment_not_near_patch_time");
        }
