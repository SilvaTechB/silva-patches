...
public class CustomDialogListPreference extends ListPreference {
    ...
    public static final int ID_SILVA_CHECK_ICON = getIdentifierOrThrow(
            ResourceType.ID, "silva_check_icon");
    public static final int ID_SILVA_CHECK_ICON_PLACEHOLDER = getIdentifierOrThrow(
            ResourceType.ID, "silva_check_icon_placeholder");
    public static final int ID_SILVA_ITEM_TEXT = getIdentifierOrThrow(
            ResourceType.ID, "silva_item_text");
    public static final int LAYOUT_SILVA_CUSTOM_LIST_ITEM_CHECKED = getIdentifierOrThrow(
            ResourceType.LAYOUT, "silva_custom_list_item_checked");
    public static final int DRAWABLE_CHECKMARK = getIdentifierOrThrow(
            ResourceType.DRAWABLE, "silva_settings_custom_checkmark");
    public static final int DRAWABLE_CHECKMARK_BOLD = getIdentifierOrThrow(
            ResourceType.DRAWABLE, "silva_settings_custom_checkmark_bold");
    ...
    public static class ListPreferenceArrayAdapter extends ArrayAdapter<CharSequence> {
        ...
        public View getView(int position, View convertView, @NonNull ViewGroup parent) {
            ...
            if (view == null) {
                ...
                holder.placeholder = view.findViewById(ID_SILVA_CHECK_ICON_PLACEHOLDER);
                holder.itemText = view.findViewById(ID_SILVA_ITEM_TEXT);
                holder.checkIcon = view.findViewById(ID_SILVA_CHECK_ICON);
