...
import static app.silva.extension.shared.settings.BaseSettings.DEBUG;
import static app.silva.extension.shared.settings.BaseSettings.DEBUG_STACKTRACE;
import static app.silva.extension.shared.settings.BaseSettings.DEBUG_TOAST_ON_ERROR;
...
import app.silva.extension.shared.settings.preference.LogBufferManager;
...
public class Logger {
     ...
     */
    private static final String SILVA_LOG_TAG_PREFIX = "morphe: ";
    ...
    private static void logInternal(LogLevel logLevel, LogMessage message, @Nullable Throwable ex,
        ...
        String logTag = SILVA_LOG_TAG_PREFIX + className;
        switch (logLevel) {
            case DEBUG:
