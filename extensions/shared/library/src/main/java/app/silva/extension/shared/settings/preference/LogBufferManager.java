...
public final class LogBufferManager {
    ...
    public static void exportToClipboard() {
        try {
            ...
            if (logBuffer.isEmpty()) {
                Utils.showToastShort(str("silva_debug_logs_none_found"));
            ...
            Utils.showToastShort(str("silva_debug_logs_copied_to_clipboard"));

            Utils.setClipboard(String.join("\n", logBuffer));
        } catch (Exception ex) {
            // Handle security exception if clipboard access is denied.
            String errorMessage = String.format(str("silva_debug_logs_failed_to_export"), ex.getMessage());
    ...
    public static void clearLogBuffer() {
        ...
        Utils.showToastShort(str("silva_debug_logs_clear_toast"));
        clearLogBufferData();
    }
}
