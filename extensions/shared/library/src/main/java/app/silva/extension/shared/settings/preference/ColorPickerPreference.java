...
import app.silva.extension.shared.ui.ColorDot;
...
public class ColorPickerPreference extends EditTextPreference {
    ...
    public static final int ID_SILVA_COLOR_PICKER_VIEW =
            getIdentifierOrThrow(ResourceType.ID, "silva_color_picker_view");
    public static final int ID_PREFERENCE_COLOR_DOT =
            getIdentifierOrThrow(ResourceType.ID, "preference_color_dot");
    public static final int LAYOUT_SILVA_COLOR_DOT_WIDGET =
            getIdentifierOrThrow(ResourceType.LAYOUT, "silva_color_dot_widget");
    public static final int LAYOUT_SILVA_COLOR_PICKER =
            getIdentifierOrThrow(ResourceType.LAYOUT, "silva_color_picker");
    ...
    private void init() {
        ...
        setWidgetLayoutResource(LAYOUT_SILVA_COLOR_DOT_WIDGET);
    }
    ...
    public void setText(String colorString) {
        try {
            ...
            Utils.showToastShort(str("silva_settings_color_invalid"));
    ...
    protected void showDialog(Bundle state) {
        ...
        View colorPicker = LayoutInflater.from(context).inflate(LAYOUT_SILVA_COLOR_PICKER, null);
        dialogColorPickerView = colorPicker.findViewById(ID_SILVA_COLOR_PICKER_VIEW);
        ...
        Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                context,
                getTitle() != null ? getTitle().toString() : str("silva_settings_color_picker_title"),
                null,
                null,
                null,
                () -> { // OK button action.
                ...
                str("silva_settings_reset_color"), // Neutral button text.
