...
package app.silva.extension.shared.settings.preference.about;
...
public class SilvaAboutPreference extends Preference {
        ...
        private static final Map<String, String> webLinkNameReplacements = new HashMap<>() {
            {
                ...
                var websiteStringKey = "silva_settings_about_links_website";
                if (ResourceUtils.getIdentifier(ResourceType.STRING, websiteStringKey) != 0) {
                    put("website", websiteStringKey);
                    put("donate", "silva_settings_about_links_donate");
                    put("translations", "silva_settings_about_links_translations");
                    put("credits", "silva_settings_about_links_credits");
                }
            }
        };
    ...
    public static void showVancedAsPastContributor(boolean includeVanced) {
        SilvaCreditsDialog.showVancedAsPastContributor = includeVanced;
    }
    ...
    private String createDialogHtml(List<WebLink> aboutLinks, @Nullable String currentVersion) {
        ...
        String versionTitle = isUpToDate
                ? getString("silva_settings_about_links_dev_header_up_to_date")
                : getString("silva_settings_about_links_dev_header_update_available");
        html.append(String.format("""
                <div class="info-card">
                    <h3>%s</h3>
                    <p>%s</p>
                ...
                useNonBreakingHyphens(isUpToDate
                        ? getString("silva_settings_about_links_body_version_current", appPatchesVersion)
                        : getString("silva_settings_about_links_body_version_outdated", appPatchesVersion, currentVersion)
                )
        ));
        ...
        if (Utils.isPreReleasePatches()) {
            html.append(String.format("""
                            ...
                            """, useNonBreakingHyphens(getString("silva_settings_about_links_dev_header")),
                    getString("silva_settings_about_links_dev_body")
            ));
        }
        ...
        html.append(String.format("""
                ...
                """, getString("silva_settings_about_links_header")));
    ...
    public SilvaAboutPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }
    public SilvaAboutPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }
    public SilvaAboutPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public SilvaAboutPreference(Context context) {
        super(context);
    }
}
